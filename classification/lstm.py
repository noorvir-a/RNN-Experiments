...
LOAD_MODEL_FILENAME = "./T1_a_32.ckpt"
# LOAD_MODEL_FILENAME = "./T1_a_64.ckpt"
# LOAD_MODEL_FILENAME = "./T1_a_128.ckpt"
# ==================================================================================================

class RNN:
    def __init__(self, batch_size=500, learning_rate=0.0005, num_epochs=100, num_linear=100,
    ...
    def run(self, data, is_train):
        ...
        ts = datetime.datetime.fromtimestamp(t).strftime(
            '%Y%m%d %H-%M-%S')
        FILENAME = 'T1_a_' + str(self.num_hid_units) + '_' + ts
        ...
        # Accuracy measure
        prediction_outcome = tf.equal(tf.argmax(c_graph, 1), tf.argmax(self.y,
                                                                       1))
        ...
        if is_train:
            ...
            with tf.Session() as sess:
                ...
                # Output CSV
                csv_filename = LOG_FOLDER + 'T1_a_' + str(self.num_hid_units) + '_' + ts + '.csv'
